...
<!-- Begin for the Registration Styling CSS -->
    <link href="#m.siteConfig('ThemeAssetPath')#/assets/stylesheets/registration.css" rel="stylesheet">
<!-- End for the Registration Styling CSS -->
